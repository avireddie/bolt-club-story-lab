...
| R7 | Comprehension kit | Gist, recap, Exact Words trap, threading, inference present and fair | [`instructions.md` — Mission Debrief](instructions.md#mission-debrief-page) |
...
| R9 | Editor smoke | None of the [12 comprehension QA failure modes](instructions.md#comprehension-qa-editor) clearly fire | [`instructions.md` — Comprehension QA Editor](instructions.md#comprehension-qa-editor) |
